...
emp_data=data.frame(
  emp_id=c(1:10),
  emp_name=c('naman','manna','gaman','faman','raman','baman','laman','haman','kaman','vaman'),
  salary=c(3000.0,22500.0,2500.0,2100.0,1900.0,1950.0,1952.0,1458.0,2036.0,2700.0),
  start_date=as.Date(c("2013-02-11", "2016-06-22", "2020-10-05", "2017-07-11",
                       "2014-04-17","2020-07-18", "2018-09-10", "2019-09-18", "2015-01-05",
                       "2015-06-20")),
